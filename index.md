...
pre-trained models (or train your own models with DepMap data), prepare
your expression matrix, predict, and plot.
...
genes x 400 cells x 20 patients) to help you test the whole flow. See
the [Shiny App
...
| Function | Description |
|----|----|
| [`train_models()`](https://wanglabcsu.github.io/PERCEPTIONx/reference/train_models.md) | Full training pipeline |
...
| Function | Description |
|----|----|
| [`plot_tsne_response()`](https://wanglabcsu.github.io/PERCEPTIONx/reference/plot_tsne_response.md) | t-SNE/UMAP with drug response overlay |
| [`plot_tsne_biomarker_viability()`](https://wanglabcsu.github.io/PERCEPTIONx/reference/plot_tsne_biomarker_viability.md) | Biomarker vs. viability side-by-side on t-SNE |
| [`plot_clone_distribution()`](https://wanglabcsu.github.io/PERCEPTIONx/reference/plot_clone_distribution.md) | Clone abundance stacked bar chart |
| [`plot_clone_viability()`](https://wanglabcsu.github.io/PERCEPTIONx/reference/plot_clone_viability.md) | Clone-level viability lollipop plot |
