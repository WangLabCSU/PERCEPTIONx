...
- Main dependencies: `devtools`, `shiny`, `bslib`, `Seurat`, `ggplot2`, `ggiraph`, `glmnet`, `caret`, `DT`, `plotly`, `waiter`, `thematic`, `callr`, `readxl`. The app prompts you to install anything that is missing when a feature needs it.
